...
batch_size = 32
num_epochs = 15
num_classes = 2  # Cambia si usas otro número de clases
...
transform = transforms.Compose([
    transforms.Resize((224, 224)),  # EfficientNet puede aceptar 224x224 para b0
    transforms.ToTensor(),
...
# Reemplazar capa de clasificación final
